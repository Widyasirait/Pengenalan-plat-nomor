...
<body class="bg-gradient-to-br from-green-200 to-white min-h-screen relative font-sans">
    ...
    <div class="absolute top-4 right-4">
        <form id="logout-form" action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit" class="text-red-600 hover:text-red-800 text-xl" title="Logout">
        ...
        <div class="bg-white bg-opacity-90 p-10 rounded-2xl shadow-xl w-full max-w-md text-center fade-in">
            ...
            <div>
                ...
                <a href="{{ route('statistik') }}">
                    <button class="bg-green-400 hover:bg-green-500 text-white font-semibold py-4 px SIX rounded-xl w-full shadow-md transition duration-300 flex items-center justify-center space-x-3 mt-6">
